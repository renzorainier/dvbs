...
<Menu as="div" className="relative w-1/2">
  ...
  <Transition
    ...
    <Menu.Items className="origin-top-right absolute z-50 right-10 mt-2 w-96 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
