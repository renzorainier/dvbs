                ...
                <div className="text-left space-y-4 w-full text-gray-700">
                  ...
                  <p className="text-lg">
                    ...
                    <input
                      type="text"
                      name="loc"
                      value={editableStudentInfo.loc || selectedStudentInfo.loc || "NA"}
                  ...
                  <p className="text-lg">
                    ...
                    <input
                      type="text"
                      name="age"
                      value={editableStudentInfo.age || selectedStudentInfo.age || "NA"}
                      onChange={handleInputChange}
                      className="text-lg border rounded-md px-2 py-1"
                    />
                  </p>
                  <p className="text-lg">
                    ...
                    <input
                      type="text"
                      name="contactNumber"
                      value={editableStudentInfo.contactNumber || selectedStudentInfo.contactNumber || "NA"}
                      onChange={handleInputChange}
                      className="text-lg border rounded-md px-2 py-1"
                    />
                  </p>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-lg">
                      <div className="flex items-center pb-3">
                        ...
                        <input
                          type="text"
                          name="Apoints"
                          value={editableStudentInfo.Apoints || selectedStudentInfo.Apoints || ""}
                          onChange={handleInputChange}
                          className="text-lg border rounded-md px-2 py-1"
                        />
                      </div>
                      <div className="flex items-center pb-3">
                        ...
                        <input
                          type="text"
                          name="Bpoints"
                          value={editableStudentInfo.Bpoints || selectedStudentInfo.Bpoints || ""}
                          onChange={handleInputChange}
                          className="text-lg border rounded-md px-2 py-1"
                        />
                      </div>
                      <div className="flex items-center pb-3">
                        ...
                        <input
                          type="text"
                          name="Cpoints"
                          value={editableStudentInfo.Cpoints || selectedStudentInfo.Cpoints || ""}
                          onChange={handleInputChange}
                          className="text-lg border rounded-md px-2 py-1"
                        />
                      </div>
                      <div className="flex items-center pb-3">
                        ...
                        <input
                          type="text"
                          name="Dpoints"
                          value={editableStudentInfo.Dpoints || selectedStudentInfo.Dpoints || ""}
                          onChange={handleInputChange}
                          className="text-lg border rounded-md px-2 py-1"
                        />
                      </div>
                      <div className="flex items-center">
                        ...
                        <input
                          type="text"
                          name="Epoints"
                          value={editableStudentInfo.Epoints || selectedStudentInfo.Epoints || ""}
                          onChange={handleInputChange}
                          className="text-lg border rounded-md px-2 py-1"
                        />
                      </div>
                  ...
                  <p className="text-lg">
                    ...
                    <input
                      type="text"
                      name="invites"
                      value={editableStudentInfo.invites || selectedStudentInfo.invites || "NA"}
                      onChange={handleInputChange}
                      className="text-lg border rounded-md px-2 py-1"
                    />
                  </p>
