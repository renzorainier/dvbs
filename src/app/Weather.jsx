      ...
      {!loading ? (
        data && (
          <div className="w-full rounded-lg" style={{ maxWidth: "90%" }}>
            <div className="bg-gradient-to-r text-white from-yellow-400 to-red-400 text-transparent  rounded-lg shadow-lg p-1 flex flex-row items-center justify-center space-x-4">
